var vpAttr1 = '<div class="copy-pg" id="copy-pg-id"><a id="copy-pg-icon"><i class="far fa-copyright"></i></a><span><a href="https://leafletjs.com" title="A JS library for interactive maps">Leaflet</a> | 2021 <a href="http://www.velopoltava.org">ГО «ВелоПолтава»</a>',
    vpAttr2 = '</span></div>';
